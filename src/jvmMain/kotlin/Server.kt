...
fun main() {
    ...
    embeddedServer(Netty, watchPaths = listOf("resources", "classes"), port = 8080) {
        serverSettings()
...
private fun Application.serverSettings() {
    ...
    routing {
        //get("/hello") { call.respondText("Hello, API!") }

        // statische Ressourcen, welche nicht generiert werden (Bilder, Html, Css usw.)
        // / ist der Root des Servers und static wo die Dateien sind
